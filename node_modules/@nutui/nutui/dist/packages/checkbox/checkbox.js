/*!
 * NutUI v2.2.1 - checkbox.js, 59c3ac9b1672465eeb23, 2020-03-09T09:06:03+08:00
 * (c) 2017-2019 JDC
...
/******/ 	return hotCreateRequire("./src/packages/checkbox/index.js")(__webpack_require__.s = "./src/packages/checkbox/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js!./node_modules/vue-loader/lib??vue-loader-options!./src/packages/checkbox/checkbox.vue?vue&type=template&id=05252e11&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('label',{class:['nut-checkbox','nut-checkbox-size-'+_vm.size]},[_c('input',{class:{'nut-checkbox-ani':_vm.animation},attrs:{"type":"checkbox","name":_vm.name,"disabled":_vm.disabled},domProps:{"checked":_vm.isChecked,"value":_vm.submittedValue},on:{"change":_vm.changeEvt}}),_vm._v(" "),(_vm.label)?_c('span',{staticClass:"nut-checkbox-label"},[_vm._v("\n   \t\t"+_vm._s(_vm.label)+"\n   \t")]):_c('span',{staticClass:"nut-checkbox-label"},[_vm._t("default")],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/packages/checkbox/checkbox.vue?vue&type=template&id=05252e11&
...
// CONCATENATED MODULE: ./node_modules/happypack/loader.js?id=Babel!./node_modules/cache-loader/dist/cjs.js!./node_modules/vue-loader/lib??vue-loader-options!./src/packages/checkbox/checkbox.vue?vue&type=script&lang=js&
var cov_1lvnlerid9 = function () {
  var path = "/Users/zhuzhida/Documents/JD_Project/nutui/src/packages/checkbox/checkbox.vue",
      hash = "2d5a7290e56a59e5fa8e4ef4860427ef51abef6c",
      Function = function () {}.constructor,
      global = new Function('return this')(),
      gcv = "__coverage__",
      coverageData = {
    path: "/Users/zhuzhida/Documents/JD_Project/nutui/src/packages/checkbox/checkbox.vue",
    statementMap: {
      "0": {
        start: {
          line: 65,
    ...
    inputSourceMap: {
      version: 3,
      sources: ["checkbox.vue"],
      names: [],
      mappings: ";;;;;;;;;;;;;;;;;;;;;AAqBA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;;AAEA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;;AAEA;AACA;AACA;AACA;;AAEA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;AACA;;AAEA;AACA;AACA;AACA;AACA;AACA;AACA",
      file: "checkbox.vue",
      sourceRoot: "src/packages/checkbox",
...
/* harmony default export */ var checkboxvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    cov_1lvnlerid9.s[2]++;
    return {
      isChecked: (cov_1lvnlerid9.b[0][0]++, this.value == this.trueValue) || (cov_1lvnlerid9.b[0][1]++, this.checked)
    };
  },
  mounted: function mounted() {
    cov_1lvnlerid9.s[3]++;
    this.$emit('update:checked', this.isChecked ? (cov_1lvnlerid9.b[1][0]++, this.trueValue) : (cov_1lvnlerid9.b[1][1]++, this.falseValue), this.label);
    cov_1lvnlerid9.s[4]++;
    this.$emit('input', this.isChecked ? (cov_1lvnlerid9.b[2][0]++, this.trueValue) : (cov_1lvnlerid9.b[2][1]++, this.falseValue), this.label);
  },
  methods: {
    isObject: function isObject(obj) {
      cov_1lvnlerid9.s[5]++;
      return (cov_1lvnlerid9.b[3][0]++, obj !== null) && (cov_1lvnlerid9.b[3][1]++, typeof_default()(obj) === 'object');
    },
    looseEqual: function looseEqual(a, b) {
      cov_1lvnlerid9.s[6]++;
      return (cov_1lvnlerid9.b[4][0]++, a == b) || (cov_1lvnlerid9.b[4][1]++, (cov_1lvnlerid9.b[6][0]++, this.isObject(a)) && (cov_1lvnlerid9.b[6][1]++, this.isObject(b)) ? (cov_1lvnlerid9.b[5][0]++, JSON.stringify(a) === JSON.stringify(b)) : (cov_1lvnlerid9.b[5][1]++, false));
    },
    changeEvt: function changeEvt(event) {
      var isCheckedPrevious = (cov_1lvnlerid9.s[7]++, this.isChecked);
      var isChecked = (cov_1lvnlerid9.s[8]++, event.target.checked);
      cov_1lvnlerid9.s[9]++;
      this.$emit('input', isChecked ? (cov_1lvnlerid9.b[7][0]++, this.trueValue) : (cov_1lvnlerid9.b[7][1]++, this.falseValue), this.label, event);
      cov_1lvnlerid9.s[10]++;

      if (isCheckedPrevious !== isChecked) {
        cov_1lvnlerid9.b[8][0]++;
        cov_1lvnlerid9.s[11]++;
        this.$emit('change', isChecked ? (cov_1lvnlerid9.b[9][0]++, this.trueValue) : (cov_1lvnlerid9.b[9][1]++, this.falseValue), this.label, event);
      } else {
        cov_1lvnlerid9.b[8][1]++;
      }
    }
  }
});
...
/* harmony import */ var _checkbox_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/packages/checkbox/checkbox.vue");
/* harmony import */ var _checkbox_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/packages/checkbox/checkbox.scss");
...
/* harmony default export */ __webpack_exports__["default"] = (_checkbox_vue__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]);
